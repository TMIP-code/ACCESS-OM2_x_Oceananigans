...
python3 scripts/periodicaverage_ACCESS-OM2_025deg_jra55_iaf_omip2_cycle6.py \
&> output/periodicaverage_ACCESS-OM2_025deg_jra55_iaf_omip2_cycle6.$PBS_JOBID.out
