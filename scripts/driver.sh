...
COMMON_VARS+=",CALENDAR_YEAR_OFFSET=${CALENDAR_YEAR_OFFSET}"
...
# plotAgeLog (no deps — reads saved per-rank age_1year_rank*.jld2 for the
# current MODEL_CONFIG/PARTITION; standalone diagnostic for instabilities)
has_step plotAgeLog && \
