...
echo "Cross-checking v blow-up cell for $EXPERIMENT ($TIME_WINDOW)"
julia --project src/probe_v_blowup_cell.jl &> "$log_dir/v_blowup_cell_${job_id}.log"
echo "Done. Log: $log_dir/v_blowup_cell_${job_id}.log"
