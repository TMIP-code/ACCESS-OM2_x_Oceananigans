...
echo "Probing face-area metrics for $EXPERIMENT ($TIME_WINDOW)"
julia --project src/probe_face_area_metrics.jl &> "$log_dir/face_area_metrics_${job_id}.log"
echo "Done. Log: $log_dir/face_area_metrics_${job_id}.log"
