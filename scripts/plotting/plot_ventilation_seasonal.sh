...
echo "Plotting seasonal ventilation diagnostic for MODEL_CONFIG=$MODEL_CONFIG TIME_WINDOW=$TIME_WINDOW"
log_file="$run_log_dir/plot_ventilation_seasonal_${MODEL_CONFIG}_${job_id}.log"
julia --project src/plot_ventilation_seasonal.jl &> "$log_file"
echo "Done plotting seasonal ventilation diagnostic"
