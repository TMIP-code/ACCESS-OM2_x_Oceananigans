...
echo "Animating ventilation diagnostic for MODEL_CONFIG=$MODEL_CONFIG TIME_WINDOW=$TIME_WINDOW"
log_file="$run_log_dir/animate_ventilation_${MODEL_CONFIG}_${job_id}.log"
julia --project src/animate_ventilation.jl &> "$log_file"
echo "Done animating ventilation diagnostic"
