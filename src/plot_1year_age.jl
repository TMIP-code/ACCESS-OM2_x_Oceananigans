"""
Plot age diagnostic figures from saved 1-year simulation output.
...
label = "age_1year_$(ADVECTION_SCHEME)"
...
@info "plot_1year_age.jl complete"
flush(stdout); flush(stderr)
