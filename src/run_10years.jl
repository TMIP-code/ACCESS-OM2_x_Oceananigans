"""
Run a standalone 10-year offline age simulation.

This is a lightweight test/debug script that runs the model for ten years
and saves full output (age, u, v, w, η) every year.

Usage — interactive:
```
qsub -I -P y99 -l mem=47GB -q gpuvolta -l walltime=02:00:00 -l ncpus=12 -l ngpus=1 \\
     -l storage=gdata/xp65+gdata/ik11+scratch/y99+gdata/y99 -o logs/PBS/ -j oe
cd /home/561/bp3051/Projects/TMIP/ACCESS-OM2_x_Oceananigans
module load cuda/12.9.0
export JULIA_CUDA_USE_COMPAT=false
julia --project
include("src/run_10years.jl")
```
...
# Override stop_time for 10-year simulation
...
age_output_dir = setup_age_simulation(
    simulation, outputdir, model_config, "10years" * noACM_suffix();
    output_interval = 12 * prescribed_Δt,
    progress_interval = 12 * prescribed_Δt,
)
