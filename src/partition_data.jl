...
# Include monthly MLD if the clo step has produced it (required for distributed KAPPAV_FROM_MLD=yes).
isfile(joinpath(monthly_dir, "mld_monthly.jld2")) && push!(fts_fields, ("mld", "MLD"))
