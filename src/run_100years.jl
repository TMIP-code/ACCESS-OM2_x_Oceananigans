...
add_callback!(simulation, progress_message, TimeInterval(10 * 12 * prescribed_Δt))
...
output_prefix = joinpath(age_output_dir, "age_100years")

simulation.output_writers[:fields] = JLD2Writer(
    model, output_fields;
    schedule = TimeInterval(10 * 12 * prescribed_Δt),
...
@info "Validating age field after 100-year simulation"
flush(stdout)
...
@info "Run plot_100years_age.jl on CPU to generate age diagnostic plots"
flush(stdout)
