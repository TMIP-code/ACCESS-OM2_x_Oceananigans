"""
Plot age diagnostic figures from saved 100-year simulation output.
...
julia --project
include("src/plot_100years_age.jl")
```
...
if !isempty(ARGS)
    ...
    output_filepath = joinpath(age_output_dir, "age_100years.jld2")
end
...
label = "age_100years_$(ADVECTION_SCHEME)"
...
plot_age_diagnostics(
    ...
    colorrange = (0, 100), levels = 0:10:100
)

@info "plot_100years_age.jl complete"
flush(stdout); flush(stderr)
